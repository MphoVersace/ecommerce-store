...
export default function Bag() {
    ...
    return (
        <div className="cart">
            ...
            <Link to="/bag-details" style={{ textDecoration: 'none', padding: '10px 20px', backgroundColor: 'black', color: 'white', borderRadius: '11px 11px', fontSize: '18px' }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: '10px', color: 'white', stroke: 'white', fill: 'white' }}>
